...
if __name__=="__main__":
    # load back the model
    cnn = CNNNetwork()
    state_dict = torch.load("/Users/milindsoorya/Desktop/ml-projects/AudioProcessingPyTorch/09 Predictions with sound classifier/cnnnet.pth", map_location=torch.device('cpu'))
